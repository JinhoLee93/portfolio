...
class Helpers:
    def load_test_data():
        ...
        ArticleMetadata.objects.all().delete()
        ArticleAuxiliaryData.objects.all().delete()
        ...
        article1_moving_metadata = ArticleMetadata.objects.create(article=article1_moving, time_to_read=1, date='2024-05-07')
        article1_moving_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article1_moving)
        ...
        article2_moving_metadata = ArticleMetadata.objects.create(article=article2_moving, time_to_read=1, date='2024-05-07')
        article2_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article2_moving)
        ...
        article3_moving_metadata = ArticleMetadata.objects.create(article=article3_moving, time_to_read=1, date='2024-05-07')
        article3_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article3_moving)
        ...
        article4_moving_metadata = ArticleMetadata.objects.create(article=article4_moving, time_to_read=1, date='2024-05-07')
        article4_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article4_moving)
        ...
        article5_moving_metadata = ArticleMetadata.objects.create(article=article5_moving, time_to_read=1, date='2024-05-07')
        article5_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article5_moving)
        ...
        article6_moving_metadata = ArticleMetadata.objects.create(article=article6_moving, time_to_read=1, date='2024-05-07')
        article6_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article6_moving)
        ...
        article7_moving_metadata = ArticleMetadata.objects.create(article=article7_moving, time_to_read=1, date='2024-05-07')
        article7_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article7_moving)
        ...
        article8_moving_metadata = ArticleMetadata.objects.create(article=article8_moving, time_to_read=1, date='2024-05-07')
        article8_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article8_moving)
        ...
        article9_moving_metadata = ArticleMetadata.objects.create(article=article9_moving, time_to_read=1, date='2024-05-07')
        article9_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article9_moving)
        ...
        article10_moving_metadata = ArticleMetadata.objects.create(article=article10_moving, time_to_read=1, date='2024-05-07')
        article10_moving_auxiliay_data = ArticleAuxiliaryData.objects.create(article=article10_moving)
        ...
        article1_happy_metadata = ArticleMetadata.objects.create(article=article1_happy, time_to_read=1, date='2024-05-07')
        article1_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article1_happy)
        ...
        article2_happy_metadata = ArticleMetadata.objects.create(article=article2_happy, time_to_read=1, date='2024-05-07')
        article2_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article2_happy)
        ...
        article3_happy_metadata = ArticleMetadata.objects.create(article=article3_happy, time_to_read=1, date='2024-05-07')
        article3_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article3_happy)
        ...
        article4_happy_metadata = ArticleMetadata.objects.create(article=article4_happy, time_to_read=1, date='2024-05-07')
        article4_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article4_happy)
        ...
        article5_happy_metadata = ArticleMetadata.objects.create(article=article5_happy, time_to_read=1, date='2024-05-07')
        article5_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article5_happy)
        ...
        article6_happy_metadata = ArticleMetadata.objects.create(article=article6_happy, time_to_read=1, date='2024-05-07')
        article6_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article6_happy)
        ...
        article8_happy_metadata = ArticleMetadata.objects.create(article=article8_happy, time_to_read=1, date='2024-05-07')
        article8_happy_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article8_happy)
        ...
        article1_amazing_metadata = ArticleMetadata.objects.create(article=article1_amazing, time_to_read=1, date='2024-05-07')
        article1_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article1_amazing)
        ...
        article2_amazing_metadata = ArticleMetadata.objects.create(article=article2_amazing, time_to_read=1, date='2024-05-07')
        article2_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article2_amazing)
        ...
        article3_amazing_metadata = ArticleMetadata.objects.create(article=article3_amazing, time_to_read=1, date='2024-05-07')
        article3_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article3_amazing)
        ...
        article4_amazing_metadata = ArticleMetadata.objects.create(article=article4_amazing, time_to_read=1, date='2024-05-07')
        article4_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article4_amazing)
        ...
        article5_amazing_metadata = ArticleMetadata.objects.create(article=article5_amazing, time_to_read=1, date='2024-05-07')
        article5_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article5_amazing)
        ...
        article6_amazing_metadata = ArticleMetadata.objects.create(article=article6_amazing, time_to_read=1, date='2024-05-07')
        article6_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article6_amazing)
        ...
        article7_amazing_metadata = ArticleMetadata.objects.create(article=article7_amazing, time_to_read=1, date='2024-05-07')
        article7_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article7_amazing)
        ...
        article8_amazing_metadata = ArticleMetadata.objects.create(article=article8_amazing, time_to_read=1, date='2024-05-07')
        article8_amazing_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article8_amazing)
        ...
        article1_funny_metadata = ArticleMetadata.objects.create(article=article1_funny, time_to_read=1, date='2024-05-07')
        article1_funny_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article1_funny)
        ...
        article2_funny_metadata = ArticleMetadata.objects.create(article=article2_funny, time_to_read=1, date='2024-05-07')
        article2_funny_auxiliary_data = ArticleAuxiliaryData.objects.create(article=article2_funny)