# PokeDex (포켓몬 도감)
**- 사용된 디자인 패턴 및 개발 기술: MVVM, Protocol Oriented Programming, Dependency Injection**
...
### 디자인 패턴
- **MVVM**: 쉬운 디버깅과 테스트, 그리고 가독성 높은 코드를 만들면서 각 모듈(Model, View, ViewModel)마다 해야할 일이 정확히 정해진 Clean Architecture를 구현하기 위하여 MVVM 디자인 패턴을 사용하였습니다.
...
- [ ] CoreData 프레임워크를 사용해 로컬 데이터베이스 구축
