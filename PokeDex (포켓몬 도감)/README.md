...
개발 초기엔 검색 기능이 있는 도감의 특성상, 1000개가 넘는 포켓몬 엔트리를 한 번에 받아오는 것을 통해 모든 포켓몬을 검색할 수 있게 만들었지만, 테이블 뷰 셀 내부 이미지를 위해 너무 많은 네트워크 콜을 불러 빈번한 "HTTP Load Failed" 에러가 발생했습니다. 이를 해결하기 위해 한 번에 20개의 포켓몬 엔트리만을 받아올 수 있도록 Infinite Scroll을 구현하였습니다.
